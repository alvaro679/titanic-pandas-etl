# Titanic ETL Pipeline (Pandas)

Pipeline de ingeniería de datos modular y vectorizado.
...
Se incluye una copia de ejemplo en el repositorio para facilitar la revisión.
